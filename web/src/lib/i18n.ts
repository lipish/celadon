...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    semanticMemoryTitle: "语义记忆",
    semanticMemoryDesc: "RAG 模式（约占 200MB 内存）",
    semanticMemoryEnabled: "已启用",
    semanticMemoryDisabled: "已禁用",
    plannerTitle: "规划器 (Planner)",
    executorTitle: "执行器 (Executor)",
    reflectorTitle: "审阅者 (Reflector)",
    ensureApiKeyBalance: "请确保密钥有余额并拥有对应模型的访问权限。",
  ...
  en: {
    ...
    // Admin Settings Page
    roleModuleConfig: "Module Configuration",
    ...
    semanticMemoryDesc: "RAG (Uses ~200MB RAM)",
    semanticMemoryEnabled: "ENABLED",
    semanticMemoryDisabled: "DISABLED",
    plannerTitle: "Planner (规划器)",
    executorTitle: "Executor (执行器)",
    reflectorTitle: "Reflector (审阅者)",
    ensureApiKeyBalance: "Ensure the key has balance and proper model access.",
